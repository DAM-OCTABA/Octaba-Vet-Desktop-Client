...
Public Class frmLogin
    ...
    Private Async Sub Button1_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        ...
        Timer.Interval = result.interval * 1000
        Timer.Start()
    ...
    Private Async Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer.Tick
